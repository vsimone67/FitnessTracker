...
namespace FitnessTracker.Service.Controllers
{
    ...
    public class DietController : Controller
    {
        ...
        {
            _logger.LogInformation("Getting Columns");
        ...
        {
            _logger.LogInformation("Getting Metabolic Info Calc Type");
        ...
        {
            _logger.LogInformation("Getting Metabolic Info");
        ...
        {
            _logger.LogInformation("Edit Metabolic Info");
