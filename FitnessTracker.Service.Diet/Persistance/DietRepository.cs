...
namespace FitnessTracker.Persistance.Diet
{
    ...
    public class DietRepository : IDietRepository
    {
        ...
        public DietRepository(IConfiguration settings)
        {
            _dbContext = new DietContext(settings.GetConnectionString("LocalConnection"));
        }
        ...
        {
            await _dbContext.Database.ExecuteSqlRawAsync("TRUNCATE TABLE SavedMenu");
        }
